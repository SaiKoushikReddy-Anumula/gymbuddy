...
const CustomDrawerContent: React.FC<DrawerContentComponentProps> = (props) => {
  ...
  const menuItems = [
    ...
    { icon: 'calendar', label: 'Workout Plan', route: 'WorkoutPlan' },
    { icon: 'people', label: 'Community Forum', route: 'Community' },
    { icon: 'person-add', label: 'Friends', route: 'Friends' },
    ...
    >
      <Drawer.Screen 
        ...
        options={{
          title: 'Dashboard',
          headerLeft: ({ onPress }) => (
            <TouchableOpacity style={styles.headerMenuButton} onPress={onPress}>
